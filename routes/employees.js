...
EmployeeProvider = function(host, port) {
    this.db= new Db('employee', new Server(host, port, {safe: false}, {auto_reconnect: true}, {}));
...
//find all employees
EmployeeProvider.prototype.findList = function(callback) {
 ...
 * Created by Sony laptop on 16/12/13.
 */
